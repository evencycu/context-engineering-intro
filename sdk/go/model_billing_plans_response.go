...
// BillingPlansResponse struct for BillingPlansResponse
type BillingPlansResponse struct {
	Data []BillingPlanResponse `json:"data,omitempty"`
...
// SetData gets a reference to the given []BillingPlanResponse and assigns it to the Data field.
