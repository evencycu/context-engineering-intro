#!/bin/bash
# Manual test script for Microsoft Graph API /chats endpoint
# Usage: ./test_graph_chats_manual.sh <CLIENT_ID> <CLIENT_SECRET> <TENANT_ID>
...
if [ $# -lt 3 ]; then
    ...
    echo ""
    echo "Example:"
    echo "  $0 844146d7-4ac9-4e4d-a463-d6e027714e81 'your-secret' 051cece0-e4dc-4aed-b471-bf29824e1ee6"
    exit 1
fi
